...
urlpatterns = [
    ...
    path('delete/<int:pk>/', ex_views.DeleteView.as_view(), name='delete-gallery'),
    ...
    path('add_availability/<int:pk>', ex_views.AddAvailabilityView.as_view(), name='edit-profile'),
    path('create_message/', ex_views.CreateMessage.as_view(), name='create_message'),
    path('message_box/<int:pk>', ex_views.MessageBox.as_view(), name='message_box'),
